...
export default class UdGrid extends React.Component {
    ...
    loadData(page, pageSize, sortColumn, sortAscending, filterText) {
        ...
        UniversalDashboard.get(`/api/internal/component/element/${this.props.id}?start=${skip}&length=${pageSize}&sortColumn=${sortColumn}&sortAscending=${sortAscending}&filterText=${filterText}`, function(json){
