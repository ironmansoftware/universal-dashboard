...
New-UDDashboard -Title "Dashboard" -Pages @(
    ...
    New-UDPage -Name 'Element' -Content {
        ...
        New-UDButton -Text 'Get' -OnClick {
            $Element = Get-UDElement -Id 'Parent'
            Show-UDToast -Message $Element.Tag
        }
