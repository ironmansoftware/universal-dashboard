...
### Divider
```
New-UDSideNavItem [-Divider] [-Id <String>] [<CommonParameters>]
```

### SubHeader
```
New-UDSideNavItem [-SubHeader] [-Children <ScriptBlock>] [-Text <String>] [-Icon <FontAwesomeIcons>]
 [-Id <String>] [<CommonParameters>]
```

### Url
```
New-UDSideNavItem [-Url <String>] [-Text <String>] [-Icon <FontAwesomeIcons>] [-Id <String>]
 [<CommonParameters>]
```

### OnClick
```
New-UDSideNavItem [-Text <String>] [-Icon <FontAwesomeIcons>] [-OnClick <Object>] [-Id <String>]
 [<CommonParameters>]
```
...
### -Children
Adds children to this side navigation item. This creates a drop down element.
