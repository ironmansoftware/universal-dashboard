...
```
New-UDIcon [[-Id] <String>] [-Icon] <FontAwesomeIcons> [[-Size] <String>] [-FixedWidth]
...
### Example 1
```
PS C:\> New-UDIcon -Icon user -Size Large -FixedWidth
```

Creates a large user icon with a fixed width.
...
### -FixedWidth
Whether the icon is fixed width.
...
Parameter Sets: (All)
Aliases: 
Accepted values: ExtraSmall, Small, Large, 2x, 3x, 4x, 5x
