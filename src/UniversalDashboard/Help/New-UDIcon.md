...
### Example 1
```powershell
PS C:\>  New-UDIcon -Icon box -Style @{color = '#000'} -Id 'test-icon-button' 
```
...
### Example 2
```powershell
PS C:\>  New-UDIcon -Icon spinner -Size 3x -Style @{color = '#000'} -Id 'test-icon-button' -Spin
```
...
### Example 3
```powershell
PS C:\>  New-UDIcon -Icon angry -Size 3x -Style @{color = '#000'} -Id 'test-icon-button' -Regular
```
