...
```
New-UDFabButton [[-Id] <String>] [[-ButtonColor] <DashboardColor>] [[-Icon] <FontAwesomeIcons>]
 [[-Size] <Object>] [[-onClick] <Object>] [<CommonParameters>]
```
...
### -onClick
The event handler to invoke when the button is clicked. This can be a script block or an endpoint created with New-UDEndpoint.
