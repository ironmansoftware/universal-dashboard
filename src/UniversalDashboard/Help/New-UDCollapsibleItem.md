...
### endpoint
```
New-UDCollapsibleItem [-Id <String>] [-Title <String>] [-Icon <FontAwesomeIcons>] [-Endpoint <ScriptBlock>]
 [-AutoRefresh] [-RefreshInterval <Int32>] [-Active] [-BackgroundColor <DashboardColor>]
 [-FontColor <DashboardColor>] [<CommonParameters>]
```

## DESCRIPTION
Creates a collapsible item. Use with New-UDCollapsible. This will create a single item within the collapsible. 
...
### -Active
Specifies whether the item is active by default. This will expand the item. 
