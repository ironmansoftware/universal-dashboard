...
```
New-UDTreeNode [-Name] <String> [-Id <String>] [-Children <ScriptBlock>] [-Icon <FontAwesomeIcons>]
 [<CommonParameters>]
```
...
### -Icon
The icon to display in the tree node. 
...
### -Name
The text to display in this tree node. 
