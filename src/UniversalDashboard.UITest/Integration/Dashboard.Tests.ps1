...
Describe "Dashboard" {
    ...
    Context "Navigation" {
        ...
        $Navigation = New-UDSideNav -Content {
            New-UDSideNavItem -Text "My First Page" -PageName "Page Name" -Icon user -Id 'first-page'
        ...
        $Dashboard = New-UDDashboard -Title "Navigation" -Pages @($Page1, $Page2) -Navigation $Navigation  -DefaultFramework $Framework
        ...
        It 'should navigate custom navigation' {
            ...
            $Element = Find-SeElement -Id "first-page" -Driver $Driver | Select-Object -First 1
            Invoke-SeClick $Element
        ...
        It 'should use a fixed menu' {
            ...
            $Navigation = New-UDSideNav -Content {
                ...
                New-UDSideNavItem -Text "My Second Page" -PageName "Page Name 2" -Icon User -Id 'second-page'
                New-UDSideNavItem -Text "Google" -Url 'https://www.google.com' -Icon Users
            } -Fixed
            ...
            Find-SeElement -Id "page-1" -Driver $Driver | Should not be $null | Select-Object -First 1
            
            $Element = Find-SeElement -Id "second-page" -Driver $Driver
            Invoke-SeClick $Element
        ...
        It 'should create nested items' {
            ...
            $Element = Find-SeElement -Id "section" -Driver $Driver | Select-Object -First 1
            Invoke-SeClick $Element

            Start-Sleep 1

            $Element = Find-SeElement -Id "second-page" -Driver $Driver | Select-Object -First 1
            Invoke-SeClick $Element
        ...
        It 'should load items from endpoint' {
            ...
            $Navigation = New-UDSideNav -Endpoint {
                New-UDSideNavItem -Text "My First Page" -OnClick { Show-UDModal -Content { New-UDCard -Id "ModalCard" } } -Icon user -Id 'first-page'
            } -Fixed
            ...
            $Element = Find-SeElement -Id "first-page" -Driver $Driver 
            Invoke-SeClick $Element
    ...
    Context "Initialization Script" {
        ...
        } -EndpointInitialization $Init -Scripts "https://unpkg.com/leaflet@1.3.1/dist/leaflet.js" -DefaultFramework $Framework
