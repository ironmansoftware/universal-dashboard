...
namespace UniversalDashboard.Controllers
{
	...
	public class DashboardController : Controller
    {
		...
		public DashboardController(Dashboard dashboard, IAssetService assetService, ILogger<DashboardController> logger)
		{
        ...
        public IActionResult Theme()
	    {
            try
            {
                ...
                foreach(var item in _assetService.Assets.Where(m => m.EndsWith(".css", StringComparison.OrdinalIgnoreCase)))
                {
                    try
                    {
